...
#include <array>
#include "common/dlt698protocolconformance.h"
#include "common/dlt698functionconformance.h"
...
public:
    ...
    shared_ptr<Dlt698::FactoryVersion> getFactoryver() const;
    void setFactoryver(const shared_ptr<Dlt698::FactoryVersion> &value);
...
private:
    ...
    shared_ptr<Dlt698::FactoryVersion> factoryver;//服务器厂商版本信息

...
shared_ptr<Dlt698::FactoryVersion> Dlt698ConnectResponse::getFactoryver() const
{
    return factoryver;
}

void Dlt698ConnectResponse::setFactoryver(const shared_ptr<Dlt698::FactoryVersion> &value)
{
    factoryver = value;
}
